...
public class StudentLogin {
	...
	public String toString() {
		return "StudentLogin [student_id=" + student_id + ", firstName=" + firstName + ", lastName=" + lastName
				+ ", gender=" + gender + ", email=" + email + ", dob=" + dob + ", phone=" + phone + ", ssn=" + ssn
				+ ", stAddress=" + stAddress + ", testScoreList=" + testScoreList + ", apartmentNo=" + apartmentNo
				+ ", city=" + city + ", stateOrTeritory=" + stateOrTeritory + ", country=" + country + ", zipcode="
				+ zipcode + ", degreeEarned=" + degreeEarned + ", gpa=" + gpa + ", major=" + major + ", workOrgName="
				+ workOrgName + ", yearsWorked=" + yearsWorked + ", keyRole=" + keyRole + "]";
	}

	public StudentLogin(int student_id, String firstName, String lastName, String gender, String email, Date dob,
			String phone, String ssn, String stAddress, String apartmentNo, String city, String stateOrTeritory,
			String country, String zipcode, Double gpa, String major, String workOrgName,
			Double yearsWorked, String keyRole) {
		super();
		this.student_id = student_id;
		this.firstName = firstName;
		this.lastName = lastName;
